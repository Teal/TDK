define(["require", "exports", "/tdk/vendors/~/D/App/Node/node_modules/svgpath/index.js", "/tdk/vendors/~/D/App/Node/node_modules/sax/lib/sax.js"], function (require, exports, SvgPath, sax_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.translateSVG = void 0;
    /**
     * 移动和缩放一个 `<svg>`
     ...
     * @param offsetX 水平的偏移
     */
    function translateSVG(svg, height, center = true, offsetY = 0, offsetX = 0) {
    ...
    exports.translateSVG = translateSVG;
    function transformNode(node, height, center, offsetY, offsetX, context) {
        switch (node.name) {
            case "svg":
            case "symbol":
                let originalX = 0;
...
//# sourceMappingURL=svgTranslator.js.map