define(["require", "exports", "/tdk/vendors/~/D/App/Node/node_modules/svgo/lib/svgo.js"], function (require, exports, SVGO) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.optimizeSVG = void 0;
    /**
     * 压缩优化指定的 `<svg>` 图标
     * @param svg 要优化的 `<svg>` 源码
     * @param removeRoot 是否删除根节点
     */
    async function optimizeSVG(svg, removeRoot) {
        const svgo = new SVGO({
            full: true,
            plugins: [
                { cleanupAttrs: true },
