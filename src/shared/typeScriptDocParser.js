...
define(["require", "exports", "path", "/tdk/vendors/_typescript@4.2.0-dev.20201107@typescript/lib/typescript.js"], function (require, exports, path_1, ts) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DocTypeType = exports.DocMemberModifiers = exports.DocMemberType = exports.TypeScriptDocParser = void 0;
    ts = __importStar(ts);
    ...
    class TypeScriptDocParser {
        ...
        parseModule(symbol, result) {
            ...
            try {
                ...
                result.name = path_1.relative(process.cwd(), result.name).replace(/\\/g, "/");
        ...
        getSourceLocation(node, sourceFile = node.getSourceFile()) {
            ...
            return {
                sourcePath: path_1.resolve(sourceFile.fileName),
                start,
                end,
                line: startLoc.line,
    ...
    exports.TypeScriptDocParser = TypeScriptDocParser;
    /** 缓存键 */
    ...
    })(DocMemberType = exports.DocMemberType || (exports.DocMemberType = {}));
    /** 表示成员修饰符 */
    var DocMemberModifiers;
    ...
    })(DocMemberModifiers = exports.DocMemberModifiers || (exports.DocMemberModifiers = {}));
    /** 表示类型类型的枚举 */
    var DocTypeType;
    ...
    })(DocTypeType = exports.DocTypeType || (exports.DocTypeType = {}));
});
