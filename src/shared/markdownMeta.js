define(["require", "exports", "./yaml.js"], function (require, exports, yaml_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.parseMarkdownMeta = void 0;
    /**
     * 解析 Markdown 的信息
    ...
    function parseMarkdownMeta(content) {
        ...
        if (frontMatterMatch) {
            Object.assign(result, yaml_1.parseYAML(frontMatterMatch[1]));
    ...
    exports.parseMarkdownMeta = parseMarkdownMeta;
});
