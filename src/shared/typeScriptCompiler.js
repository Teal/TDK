...
define(["require", "exports", "/tdk/vendors/_typescript@4.2.0-dev.20201107@typescript/lib/typescript.js"], function (require, exports, ts) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.normalizeCompilerOptions = exports.readTSConfig = exports.TypeScriptCompiler = void 0;
    ts = __importStar(ts);
     ...
     */
    function readTSConfig(path, configFilePaths) {
        var _a;
     ...
     */
    function normalizeCompilerOptions(options, baseDir) {
    ...
    exports.normalizeCompilerOptions = normalizeCompilerOptions;
    /** 比较文本的差异 */
