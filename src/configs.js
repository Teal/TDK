define(["require", "exports", "fs", "/tdk/vendors/_tutils@2.1.2@tutils/misc.js", "/tdk/vendors/_tutils@2.1.2@tutils/path.js"], function (require, exports, fs_1, misc_1, path_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.version = exports.readConfigs = void 0;
    /**
     * 读取自动生成的配置
     * @param path 配置的文件路径
     */
    function readConfigs(path = "package.json") {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u;
        let pkg;
        try {
            pkg = JSON.parse(misc_1.stripBOM(fs_1.readFileSync(path, "utf8")));
        }
        catch (e) {
            pkg = {
                error: e
        ...
        const configs = (_a = pkg.tdk) !== null && _a !== void 0 ? _a : {};
        const doc = (_b = configs.doc) !== null && _b !== void 0 ? _b : (configs.doc = {});
        const git = doc.git !== false;
        (_c = doc.packageName) !== null && _c !== void 0 ? _c : (doc.packageName = pkg.private ? pkg.name : undefined);
        (_d = doc.displayName) !== null && _d !== void 0 ? _d : (doc.displayName = misc_1.capitalize(path_1.getName(pkg.name || process.cwd())));
        (_e = doc.version) !== null && _e !== void 0 ? _e : (doc.version = pkg.version);
        ...
        doc.repository = (_f = doc.repository) === null || _f === void 0 ? void 0 : _f.replace(/\/$|\.git$/i, "").replace(/^git@(.*?)[:\/](.*)$/i, "https://$1/$2");
        if (doc.branch === undefined && git) {
            for (let prevDir = "", dir = process.cwd(); prevDir.length !== dir.length; prevDir = dir, dir = path_1.getDir(dir)) {
                const path = path_1.joinPath(dir, ".git/HEAD");
                try {
                    const content = fs_1.readFileSync(path, "utf-8");
                    doc.branch = content.trim().replace(/^.*[\/\s]/, "");
                    (_g = doc.repositoryPath) !== null && _g !== void 0 ? _g : (doc.repositoryPath = path_1.relativePath(dir, process.cwd()).replace(/\\/g, "/"));
                    break;
                }
                catch (_v) { }
            }
        }
        (_h = configs.baseDir) !== null && _h !== void 0 ? _h : (configs.baseDir = ".");
        const dirs = fs_1.readdirSync(configs.baseDir);
        (_j = configs.srcDir) !== null && _j !== void 0 ? _j : (configs.srcDir = (_k = ["components", "packages", "src", "lib"].find(dir => dirs.includes(dir))) !== null && _k !== void 0 ? _k : "components");
        (_l = doc.navbar) !== null && _l !== void 0 ? _l : (doc.navbar = [
            { label: "上手", href: "guide/" },
            { label: "教程", href: "tutorial/" },
            { label: "文档", href: "docs/" },
            { label: path_1.getName(configs.srcDir) === "components" ? "组件" : "API", href: path_1.relativePath(configs.baseDir, configs.srcDir) + "/" },
            { label: "演示", href: "demo/" },
        ...
        (_m = doc.introButtons) !== null && _m !== void 0 ? _m : (doc.introButtons = [{
                label: "快速开始",
                href: (_p = (_o = doc.navbar) === null || _o === void 0 ? void 0 : _o[0]) === null || _p === void 0 ? void 0 : _p.href
            }]);
        (_q = doc.features) !== null && _q !== void 0 ? _q : (doc.features = [{
                label: "简单易用",
        ...
        (_r = doc.links) !== null && _r !== void 0 ? _r : (doc.links = [
            {
                label: path_1.getName(configs.srcDir) === "components" ? "组件列表" : "API 手册",
                href: path_1.relativePath(configs.baseDir, configs.srcDir),
        ...
        (_s = doc.support) !== null && _s !== void 0 ? _s : (doc.support = doc.repository ? {
            label: "参与贡献",
            href: doc.repository
        } : undefined);
        (_t = doc.copyright) !== null && _t !== void 0 ? _t : (doc.copyright = `© 2011-2020 The Teal Team.`);
        (_u = doc.footer) !== null && _u !== void 0 ? _u : (doc.footer = [{
