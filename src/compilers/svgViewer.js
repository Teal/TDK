define(["require", "exports", "/tdk/vendors/_tutils@2.1.2@tutils/html.js", "/tdk/vendors/_tutils@2.1.2@tutils/path.js", "../shared/svgSprite.js"], function (require, exports, html_1, path_1, svgSprite_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function default_1(content, path) {
        const icons = svgSprite_1.parseSVGSprite(content);
        const keys = Object.keys(icons);
        const name = path_1.getName(path, false);
        if (!keys.length) {
            icons[name] = content;
            keys.push(name);
        }
...
<div class="iconviewer">
	<ul class="iconviewer-container">
		${keys.map(icon => `<li onclick="iconViewerCopy(this)" title="Copy “${icon}”">
			${icons[icon]}
			<div>${html_1.encodeHTML(icon)}</div>
		</li>`).join("\n")}
	</ul>
	<script>
