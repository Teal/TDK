...
export function readConfigs(path = "package.json") {
    ...
    (_d = doc.displayName) !== null && _d !== void 0 ? _d : (doc.displayName = capitalize(getName(pkg.name || process.cwd())));
    ...
    if (doc.branch === undefined && git) {
        for (let prevDir = "", dir = process.cwd(); prevDir.length !== dir.length; prevDir = dir, dir = getDir(dir)) {
            ...
            try {
                ...
                (_g = doc.repositoryPath) !== null && _g !== void 0 ? _g : (doc.repositoryPath = relativePath(dir, process.cwd()).replace(/\\/g, "/"));
                break;
            }
            catch (_v) { }
        }
