...
import { DocCompiler } from "./compilers/docCompiler";
import { TypeScriptCompiler } from "./shared/typeScriptCompiler";
/** 表示一个构建器 */
export class Builder {
    ...
    constructor(options, devServer) {
        ...
        /** 获取外部包编译器 */
        this.externalPackageCompiler = { use: resolvePath(__dirname, "./compilers/externalPackageCompiler") };
        /** 已生成的资源缓存，键为资源地址 */
        ...
        this.fs = (_a = options.fs) !== null && _a !== void 0 ? _a : new FileSystem();
